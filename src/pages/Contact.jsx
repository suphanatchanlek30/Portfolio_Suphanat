...
const Contact = () => {
  return (
    <div className="bg-[#f7f7f7] font-body md:p-9 p-4 md:pb-[150px] pb-[50px]">
              ...
              <div className="space-y-[48px] leading-[30px]">
                ...
                <div className="text-gray-700 flex flex-row gap-6">
                  ...
                  <div className="flex flex-col">
                    <h2 className="font-medium text-[16px] text-[#232E35]">Address</h2>
                    <p className="font-normal text-[14px] text-[#656D72]">330/37 Bang Sue, Bang Sue, Bangkok</p>
                  </div>
                </div>
                ...
                <div className="text-gray-700 flex flex-row gap-6">
                  ...
                  <div className="flex flex-col">
                    <h2 className="font-medium text-[16px] text-[#232E35]">Phone</h2>
                    <p className="font-normal text-[14px] text-[#656D72]">061-260-1997</p>
                  </div>
                </div>
                ...
                <div className="text-gray-700 flex flex-row gap-6">
                  ...
                  <div className="flex flex-col">
                    <h2 className="font-medium text-[16px] text-[#232E35]">E-Mail</h2>
                    <p className="font-normal text-[14px] text-[#656D72]">suphanatchanlek@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
